...
data_types = ["your_topics", "ads_clicked", "ads_interests", "videos_watched"]
...
for idx, t in enumerate(data_types):
  ...
  with open('data/{}.json'.format(t), 'r') as t_dict:
  ...
  try:
    ...
    if idx == 0:
      ...
      values = [v['title'] for v in data['impressions_history_ads_clicked']]
    elif idx == 2:
    ...
    f = open("parsed data/{}.txt".format(t), "w")
